...
>
> Absorbed in wave **M3** (2026-08-28) of the estate's service-merge sequence.
>
> **The canonical source is [`micro-agora`](https://github.com/cloudsforge-online/micro-agora)
> at [`src/emberkin/aetherholm/`](https://github.com/cloudsforge-online/micro-agora/tree/main/src/emberkin/aetherholm).
...
> It arrived there in two steps: M3 merged it into `emberkin`, and `emberkin` itself became a module of `agora` later in the sequence. The nesting is preserved — the source sits at `src/emberkin/aetherholm`, one level deeper than the modules that moved directly.
>
>
