 ...
 *
 * aetherholm serves BOTH estates from one process since the network consolidation (micro-deploy
...
describe('the operational endpoints are exempt, and only they', () => {
  ...
  it('does not exempt anything that reads or writes', () => {
    for (const p of ['/v1/seasons', '/v1/holdings', '/v1/chronicle/seasons']) {
